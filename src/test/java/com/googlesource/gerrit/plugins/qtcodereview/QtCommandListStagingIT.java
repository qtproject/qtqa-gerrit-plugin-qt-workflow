...
public class QtCommandListStagingIT extends QtCodeReviewIT {
  ...
  private String qtListStaging(String ref, String destination) throws Exception {
    String commandStr;
    commandStr = "gerrit-plugin-qt-workflow staging-ls";
  ...
  private String qtListStagingExpectFail(String ref, String destination) throws Exception {
    String commandStr;
    commandStr = "gerrit-plugin-qt-workflow staging-ls";
    commandStr += " --project " + project.get();
    commandStr += " --branch " + ref;
